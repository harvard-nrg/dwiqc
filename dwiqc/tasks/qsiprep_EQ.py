...
class Task(tasks.BaseTask):
	...
	def build(self):
		...
		dwi_preproc_string = self.match_preproc_string(f"{self._tempdir}/qsiprep_{date}/SLURM_JOB_{self._slurm_job_id}/{self._ses}/qsiprep_wf/single_subject_{self._sub}_wf")

		qsiprep_work_dir = f"{self._tempdir}/qsiprep_{date}/SLURM_JOB_{self._slurm_job_id}/{self._ses}/qsiprep_wf/single_subject_{self._sub}_wf/{dwi_preproc_string}/hmc_sdc_wf"
